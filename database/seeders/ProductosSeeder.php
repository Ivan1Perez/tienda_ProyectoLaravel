    ...
    public function run()
    {
        $productos = [
            [
                ...
                'marca' => 'Rolex',
                'foto' => 'rolex-datejust-31-diamond-ladies.jpg',
                'precio' => 62765,
            ],
            [
                ...
                'foto' => 'audemars-piguet-royal-oak-ladies-18k.jpg',
                'precio' => 66750,
            ],
            [
                'nombre' => 'Heritage',
                ...
                'foto' => 'carl-f-bucherer-heritage-unisex.jpg',
                'precio' => 73950,
            ],
            [
                'nombre' => 'Happy Sport',
                ...
                'marca' => 'Chopard',
                'foto' => 'chopard-happy-sport-ladies.jpg',
                'precio' => 76720,
            ],
            [
                'nombre' => 'Royal',
                ...
                'marca' => 'Audemars Piguet',
                'foto' => 'audemars-piguet-royal-ladies.jpg',
                'precio' => 77500,
            ],
            [
                'nombre' => 'Code',
                ...
                'marca' => 'Audemars Piguet',
                'foto' => 'audemars-piguet-code-unisex.jpg',
                'precio' => 88750,
            ],
            [
                'nombre' => 'Metiers',
                ...
                'foto' => 'vacheron-constantin-metiers.jpg',
                'precio' => 75200,
            ],
            [
                ...
                'foto' => 'patek-philippe-complications-calatrava.jpg',
                'precio' => 75700,
            ],
            [
                'nombre' => 'D-Date 36',
